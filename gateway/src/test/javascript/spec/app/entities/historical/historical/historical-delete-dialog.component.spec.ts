...
describe('Component Tests', () => {
  describe('Historical Management Delete Component', () => {
    let comp: HistoricalDeleteDialogComponent;
    let fixture: ComponentFixture<HistoricalDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [HistoricalDeleteDialogComponent],
      })
        .overrideTemplate(HistoricalDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(HistoricalDeleteDialogComponent);
